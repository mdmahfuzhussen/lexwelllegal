...
window.addEventListener("scroll", () => {
    ...
    // Only apply the sticky scroll navbar transformation on desktop displays
    if (window.innerWidth > 900) {
        if(window.scrollY > 80){
            navbar.style.background = "#08182f";
        ...
        // Reset and wipe dynamic styles if screen resizing triggers mobile layout
